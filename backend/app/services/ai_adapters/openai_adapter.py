"""
OpenAI GPT Adapter
Implements the OpenAI AI provider.
...
class OpenAIAdapter(BaseAIAdapter):
    ...
    Attributes:
        DEFAULT_MODEL (str): Default OpenAI model name
        client (AsyncOpenAI): OpenAI async client instance
    
    SOLID Principle Applied:
        - SRP: Only responsible for OpenAI API integration
    """
    ...
    def __init__(self):
        ...
        if not settings.openai_api_key:
            raise AIAdapterError("OpenAI API key not configured")
    ...
    async def call_ai(
        ...
        """
        Call OpenAI GPT with given parameters.
        ...
        try:
            ...
            raise AIAdapterError(f"OpenAI API call failed: {str(e)}")
